view: ca_ga_all_data {
  sql_table_name: `analytics_258865309.ca_ga_all_data`
    ;;
  ...
  dimension: traffic_source__source_medium {
    type: string
    sql: concat(${traffic_source__source},'/',${traffic_source__medium}) ;;
    group_label: "Traffic Source"
    group_item_label: "source_medium"
  }
...
view: ca_ga_all_data__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: ca_ga_all_data__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
