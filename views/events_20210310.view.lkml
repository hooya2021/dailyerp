...
view: events_20210310 {
  sql_table_name: `alidbtogcp.analytics_250456953.events_20210310`
    ;;
...
view: events_20210310__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210310__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
