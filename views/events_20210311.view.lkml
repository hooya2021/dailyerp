view: events_20210311 {
  sql_table_name: `analytics_250456953.events_20210311`
    ;;
...
view: events_20210311__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210311__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
