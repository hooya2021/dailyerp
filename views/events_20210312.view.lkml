view: events_20210312 {
  sql_table_name: `analytics_250456953.events_20210312`
    ;;
...
view: events_20210312__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210312__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
