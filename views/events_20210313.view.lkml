view: events_20210313 {
  sql_table_name: `analytics_250456953.events_20210313`
    ;;
...
view: events_20210313__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210313__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
