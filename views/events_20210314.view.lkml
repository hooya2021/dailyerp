view: events_20210314 {
  sql_table_name: `analytics_250456953.events_20210314`
    ;;
...
view: events_20210314__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210314__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
