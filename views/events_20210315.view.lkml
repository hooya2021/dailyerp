view: events_20210315 {
  sql_table_name: `analytics_250456953.events_20210315`
    ;;
...
view: events_20210315__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210315__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
