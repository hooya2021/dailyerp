view: events_20210316 {
  sql_table_name: `analytics_250456953.events_20210316`
    ;;
...
view: events_20210316__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210316__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
