view: events_20210317 {
  sql_table_name: `analytics_250456953.events_20210317`
    ;;
...
view: events_20210317__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210317__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
