view: events_20210318 {
  sql_table_name: `analytics_250456953.events_20210318`
    ;;
...
view: events_20210318__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210318__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
