view: events_20210319 {
  sql_table_name: `analytics_250456953.events_20210319`
    ;;
...
view: events_20210319__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210319__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
