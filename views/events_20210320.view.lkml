view: events_20210320 {
  sql_table_name: `analytics_250456953.events_20210320`
    ;;
...
view: events_20210320__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210320__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
