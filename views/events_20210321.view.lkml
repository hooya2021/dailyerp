view: events_20210321 {
  sql_table_name: `analytics_250456953.events_20210321`
    ;;
...
view: events_20210321__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210321__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
