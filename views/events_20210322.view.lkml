view: events_20210322 {
  sql_table_name: `analytics_250456953.events_20210322`
    ;;
...
view: events_20210322__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210322__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
