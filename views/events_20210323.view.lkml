view: events_20210323 {
  sql_table_name: `analytics_250456953.events_20210323`
    ;;
...
view: events_20210323__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210323__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
