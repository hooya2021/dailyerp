view: events_20210324 {
  sql_table_name: `analytics_250456953.events_20210324`
    ;;
...
view: events_20210324__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210324__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
