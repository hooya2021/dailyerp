view: events_20210325 {
  sql_table_name: `analytics_250456953.events_20210325`
    ;;
...
view: events_20210325__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210325__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
