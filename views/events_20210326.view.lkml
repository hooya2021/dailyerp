view: events_20210326 {
  sql_table_name: `analytics_250456953.events_20210326`
    ;;
...
view: events_20210326__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210326__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
