view: events_20210327 {
  sql_table_name: `analytics_250456953.events_20210327`
    ;;
...
view: events_20210327__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210327__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
