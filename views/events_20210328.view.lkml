view: events_20210328 {
  sql_table_name: `analytics_250456953.events_20210328`
    ;;
...
view: events_20210328__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210328__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
