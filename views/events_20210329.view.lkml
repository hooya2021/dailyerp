view: events_20210329 {
  sql_table_name: `analytics_250456953.events_20210329`
    ;;
...
view: events_20210329__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210329__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
