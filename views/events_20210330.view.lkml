view: events_20210330 {
  sql_table_name: `analytics_250456953.events_20210330`
    ;;
...
view: events_20210330__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210330__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
