view: events_20210331 {
  sql_table_name: `analytics_250456953.events_20210331`
    ;;
...
view: events_20210331__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210331__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
