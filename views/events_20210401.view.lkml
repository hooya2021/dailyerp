view: events_20210401 {
  sql_table_name: `analytics_250456953.events_20210401`
    ;;
...
view: events_20210401__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210401__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
