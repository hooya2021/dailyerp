view: events_20210402 {
  sql_table_name: `analytics_250456953.events_20210402`
    ;;
...
view: events_20210402__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210402__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
