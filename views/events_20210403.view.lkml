view: events_20210403 {
  sql_table_name: `analytics_250456953.events_20210403`
    ;;
...
view: events_20210403__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210403__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
