view: events_20210404 {
  sql_table_name: `analytics_250456953.events_20210404`
    ;;
...
view: events_20210404__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210404__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
