view: events_20210405 {
  sql_table_name: `analytics_250456953.events_20210405`
    ;;
...
view: events_20210405__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210405__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
