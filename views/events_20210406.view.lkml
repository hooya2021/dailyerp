view: events_20210406 {
  sql_table_name: `analytics_250456953.events_20210406`
    ;;
...
view: events_20210406__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210406__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
