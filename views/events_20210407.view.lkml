view: events_20210407 {
  sql_table_name: `analytics_250456953.events_20210407`
    ;;
...
view: events_20210407__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210407__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
