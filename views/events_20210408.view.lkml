view: events_20210408 {
  sql_table_name: `analytics_250456953.events_20210408`
    ;;
...
view: events_20210408__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210408__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
