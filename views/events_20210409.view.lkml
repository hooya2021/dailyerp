view: events_20210409 {
  sql_table_name: `analytics_250456953.events_20210409`
    ;;
...
view: events_20210409__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210409__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
