view: events_20210410 {
  sql_table_name: `analytics_250456953.events_20210410`
    ;;
...
view: events_20210410__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210410__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
