view: events_20210411 {
  sql_table_name: `analytics_250456953.events_20210411`
    ;;
...
view: events_20210411__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210411__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
