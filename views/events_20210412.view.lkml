view: events_20210412 {
  sql_table_name: `analytics_250456953.events_20210412`
    ;;
...
view: events_20210412__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210412__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
