view: events_20210413 {
  sql_table_name: `analytics_250456953.events_20210413`
    ;;
...
view: events_20210413__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210413__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
