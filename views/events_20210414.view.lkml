view: events_20210414 {
  sql_table_name: `analytics_250456953.events_20210414`
    ;;
...
view: events_20210414__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210414__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
