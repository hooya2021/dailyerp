view: events_20210415 {
  sql_table_name: `analytics_250456953.events_20210415`
    ;;
...
view: events_20210415__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210415__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
