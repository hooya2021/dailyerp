view: events_20210416 {
  sql_table_name: `analytics_250456953.events_20210416`
    ;;
...
view: events_20210416__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210416__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
