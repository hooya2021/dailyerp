view: events_20210417 {
  sql_table_name: `analytics_250456953.events_20210417`
    ;;
...
view: events_20210417__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210417__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
