view: events_20210418 {
  sql_table_name: `analytics_250456953.events_20210418`
    ;;
...
view: events_20210418__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210418__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
