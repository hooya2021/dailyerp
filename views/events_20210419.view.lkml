view: events_20210419 {
  sql_table_name: `analytics_250456953.events_20210419`
    ;;
...
view: events_20210419__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210419__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
