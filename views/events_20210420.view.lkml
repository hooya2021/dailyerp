view: events_20210420 {
  sql_table_name: `analytics_250456953.events_20210420`
    ;;
...
view: events_20210420__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210420__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
