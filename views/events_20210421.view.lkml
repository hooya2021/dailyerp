view: events_20210421 {
  sql_table_name: `analytics_250456953.events_20210421`
    ;;
...
view: events_20210421__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210421__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
