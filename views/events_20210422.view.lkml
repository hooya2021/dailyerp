view: events_20210422 {
  sql_table_name: `analytics_250456953.events_20210422`
    ;;
...
view: events_20210422__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210422__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
