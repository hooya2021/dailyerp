view: events_20210423 {
  sql_table_name: `analytics_250456953.events_20210423`
    ;;
...
view: events_20210423__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210423__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
