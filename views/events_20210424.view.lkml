view: events_20210424 {
  sql_table_name: `analytics_250456953.events_20210424`
    ;;
...
view: events_20210424__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210424__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
