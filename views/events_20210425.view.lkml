view: events_20210425 {
  sql_table_name: `analytics_250456953.events_20210425`
    ;;
...
view: events_20210425__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210425__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
