view: events_20210426 {
  sql_table_name: `analytics_250456953.events_20210426`
    ;;
...
view: events_20210426__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210426__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
