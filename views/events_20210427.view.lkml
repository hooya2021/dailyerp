view: events_20210427 {
  sql_table_name: `analytics_250456953.events_20210427`
    ;;
...
view: events_20210427__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210427__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
