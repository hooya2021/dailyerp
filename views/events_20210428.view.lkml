view: events_20210428 {
  sql_table_name: `analytics_250456953.events_20210428`
    ;;
...
view: events_20210428__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210428__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
