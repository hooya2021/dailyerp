view: events_20210429 {
  sql_table_name: `analytics_250456953.events_20210429`
    ;;
...
view: events_20210429__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210429__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
