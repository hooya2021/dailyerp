view: events_20210430 {
  sql_table_name: `analytics_250456953.events_20210430`
    ;;
...
view: events_20210430__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210430__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
