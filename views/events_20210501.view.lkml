view: events_20210501 {
  sql_table_name: `analytics_250456953.events_20210501`
    ;;
...
view: events_20210501__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210501__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
