view: events_20210502 {
  sql_table_name: `analytics_250456953.events_20210502`
    ;;
...
view: events_20210502__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210502__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
