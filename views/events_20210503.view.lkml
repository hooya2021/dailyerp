view: events_20210503 {
  sql_table_name: `analytics_250456953.events_20210503`
    ;;
...
view: events_20210503__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210503__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
