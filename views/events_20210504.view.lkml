view: events_20210504 {
  sql_table_name: `analytics_250456953.events_20210504`
    ;;
...
view: events_20210504__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210504__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
