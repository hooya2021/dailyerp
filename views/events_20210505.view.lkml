view: events_20210505 {
  sql_table_name: `analytics_250456953.events_20210505`
    ;;
...
view: events_20210505__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210505__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
