view: events_20210506 {
  sql_table_name: `analytics_250456953.events_20210506`
    ;;
...
view: events_20210506__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210506__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
