view: events_20210507 {
  sql_table_name: `analytics_250456953.events_20210507`
    ;;
...
view: events_20210507__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210507__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
