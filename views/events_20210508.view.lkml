view: events_20210508 {
  sql_table_name: `analytics_250456953.events_20210508`
    ;;
...
view: events_20210508__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210508__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
