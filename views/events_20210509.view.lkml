view: events_20210509 {
  sql_table_name: `analytics_250456953.events_20210509`
    ;;
...
view: events_20210509__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210509__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
