view: events_20210510 {
  sql_table_name: `analytics_250456953.events_20210510`
    ;;
...
view: events_20210510__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210510__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
