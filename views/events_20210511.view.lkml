view: events_20210511 {
  sql_table_name: `analytics_250456953.events_20210511`
    ;;
...
view: events_20210511__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210511__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
