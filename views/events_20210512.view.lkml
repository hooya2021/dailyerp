view: events_20210512 {
  sql_table_name: `analytics_250456953.events_20210512`
    ;;
...
view: events_20210512__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210512__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
