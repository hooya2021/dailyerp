view: events_20210513 {
  sql_table_name: `analytics_250456953.events_20210513`
    ;;
...
view: events_20210513__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210513__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
