view: events_20210514 {
  sql_table_name: `analytics_250456953.events_20210514`
    ;;
...
view: events_20210514__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210514__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
