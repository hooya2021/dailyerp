view: events_20210515 {
  sql_table_name: `analytics_250456953.events_20210515`
    ;;
...
view: events_20210515__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210515__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
