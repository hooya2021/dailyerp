view: events_20210516 {
  sql_table_name: `analytics_250456953.events_20210516`
    ;;
...
view: events_20210516__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210516__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
