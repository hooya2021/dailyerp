view: events_20210517 {
  sql_table_name: `analytics_250456953.events_20210517`
    ;;
...
view: events_20210517__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210517__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
