view: events_20210519 {
  sql_table_name: `analytics_250456953.events_20210519`
    ;;
...
view: events_20210519__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210519__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
