view: events_20210520 {
  sql_table_name: `analytics_250456953.events_20210520`
    ;;
...
view: events_20210520__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210520__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
