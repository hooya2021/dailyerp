view: events_20210521 {
  sql_table_name: `analytics_250456953.events_20210521`
    ;;
...
view: events_20210521__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210521__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
