view: events_20210522 {
  sql_table_name: `analytics_250456953.events_20210522`
    ;;
...
view: events_20210522__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210522__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
