view: events_20210523 {
  sql_table_name: `analytics_250456953.events_20210523`
    ;;
...
view: events_20210523__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210523__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
