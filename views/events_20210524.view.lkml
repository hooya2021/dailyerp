view: events_20210524 {
  sql_table_name: `analytics_250456953.events_20210524`
    ;;
...
view: events_20210524__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210524__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
