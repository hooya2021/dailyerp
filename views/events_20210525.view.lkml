view: events_20210525 {
  sql_table_name: `analytics_250456953.events_20210525`
    ;;
...
view: events_20210525__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210525__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
