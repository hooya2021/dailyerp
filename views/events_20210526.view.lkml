view: events_20210526 {
  sql_table_name: `analytics_250456953.events_20210526`
    ;;
...
view: events_20210526__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210526__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
