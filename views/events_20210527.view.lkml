view: events_20210527 {
  sql_table_name: `analytics_250456953.events_20210527`
    ;;
...
view: events_20210527__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210527__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
