view: events_20210528 {
  sql_table_name: `analytics_250456953.events_20210528`
    ;;
...
view: events_20210528__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210528__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
