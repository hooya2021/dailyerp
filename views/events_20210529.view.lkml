view: events_20210529 {
  sql_table_name: `analytics_250456953.events_20210529`
    ;;
...
view: events_20210529__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210529__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
