view: events_20210530 {
  sql_table_name: `analytics_250456953.events_20210530`
    ;;
...
view: events_20210530__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210530__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
