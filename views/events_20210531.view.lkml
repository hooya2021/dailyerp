view: events_20210531 {
  sql_table_name: `analytics_250456953.events_20210531`
    ;;
...
view: events_20210531__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210531__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
