view: events_20210601 {
  sql_table_name: `analytics_250456953.events_20210601`
    ;;
...
view: events_20210601__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210601__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
