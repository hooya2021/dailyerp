view: events_20210602 {
  sql_table_name: `analytics_250456953.events_20210602`
    ;;
...
view: events_20210602__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210602__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
