view: events_20210603 {
  sql_table_name: `analytics_250456953.events_20210603`
    ;;
...
view: events_20210603__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210603__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
