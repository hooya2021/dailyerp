view: events_20210604 {
  sql_table_name: `analytics_250456953.events_20210604`
    ;;
...
view: events_20210604__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210604__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
