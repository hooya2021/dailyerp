view: events_20210605 {
  sql_table_name: `analytics_250456953.events_20210605`
    ;;
...
view: events_20210605__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210605__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
