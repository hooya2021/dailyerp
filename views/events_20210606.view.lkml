view: events_20210606 {
  sql_table_name: `analytics_250456953.events_20210606`
    ;;
...
view: events_20210606__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210606__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
