view: events_20210607 {
  sql_table_name: `analytics_250456953.events_20210607`
    ;;
...
view: events_20210607__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210607__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
