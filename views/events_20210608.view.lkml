view: events_20210608 {
  sql_table_name: `analytics_250456953.events_20210608`
    ;;
...
view: events_20210608__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210608__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
