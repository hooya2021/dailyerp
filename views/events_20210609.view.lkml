view: events_20210609 {
  sql_table_name: `analytics_250456953.events_20210609`
    ;;
...
view: events_20210609__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210609__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
