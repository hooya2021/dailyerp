view: events_20210610 {
  sql_table_name: `analytics_250456953.events_20210610`
    ;;
...
view: events_20210610__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210610__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
