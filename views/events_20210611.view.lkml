view: events_20210611 {
  sql_table_name: `analytics_250456953.events_20210611`
    ;;
...
view: events_20210611__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210611__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
