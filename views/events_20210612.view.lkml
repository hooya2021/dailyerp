view: events_20210612 {
  sql_table_name: `analytics_250456953.events_20210612`
    ;;
...
view: events_20210612__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210612__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
