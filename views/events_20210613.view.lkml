view: events_20210613 {
  sql_table_name: `analytics_250456953.events_20210613`
    ;;
...
view: events_20210613__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210613__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
