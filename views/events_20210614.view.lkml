view: events_20210614 {
  sql_table_name: `analytics_250456953.events_20210614`
    ;;
...
view: events_20210614__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210614__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
