view: events_20210615 {
  sql_table_name: `analytics_250456953.events_20210615`
    ;;
...
view: events_20210615__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210615__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
