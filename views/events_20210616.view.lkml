view: events_20210616 {
  sql_table_name: `analytics_250456953.events_20210616`
    ;;
...
view: events_20210616__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210616__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
