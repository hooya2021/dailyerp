view: events_20210617 {
  sql_table_name: `analytics_250456953.events_20210617`
    ;;
...
view: events_20210617__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210617__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
