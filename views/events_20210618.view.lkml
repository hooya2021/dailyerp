view: events_20210618 {
  sql_table_name: `analytics_250456953.events_20210618`
    ;;
...
view: events_20210618__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210618__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
