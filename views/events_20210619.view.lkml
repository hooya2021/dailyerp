view: events_20210619 {
  sql_table_name: `analytics_250456953.events_20210619`
    ;;
...
view: events_20210619__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210619__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
