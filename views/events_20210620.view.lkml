view: events_20210620 {
  sql_table_name: `analytics_250456953.events_20210620`
    ;;
...
view: events_20210620__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210620__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
