view: events_20210621 {
  sql_table_name: `analytics_250456953.events_20210621`
    ;;
...
view: events_20210621__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210621__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
