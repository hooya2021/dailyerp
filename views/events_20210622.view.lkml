view: events_20210622 {
  sql_table_name: `analytics_250456953.events_20210622`
    ;;
...
view: events_20210622__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210622__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
