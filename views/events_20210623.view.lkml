view: events_20210623 {
  sql_table_name: `analytics_250456953.events_20210623`
    ;;
...
view: events_20210623__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210623__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
