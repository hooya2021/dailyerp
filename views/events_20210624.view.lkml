view: events_20210624 {
  sql_table_name: `analytics_250456953.events_20210624`
    ;;
...
view: events_20210624__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210624__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
