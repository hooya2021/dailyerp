view: events_20210625 {
  sql_table_name: `analytics_250456953.events_20210625`
    ;;
...
view: events_20210625__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210625__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
