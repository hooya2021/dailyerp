view: events_20210626 {
  sql_table_name: `analytics_250456953.events_20210626`
    ;;
...
view: events_20210626__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210626__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
