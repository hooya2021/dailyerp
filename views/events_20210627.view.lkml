view: events_20210627 {
  sql_table_name: `analytics_250456953.events_20210627`
    ;;
...
view: events_20210627__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210627__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
