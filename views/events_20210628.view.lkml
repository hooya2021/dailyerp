view: events_20210628 {
  sql_table_name: `analytics_250456953.events_20210628`
    ;;
...
view: events_20210628__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210628__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
