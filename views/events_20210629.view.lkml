view: events_20210629 {
  sql_table_name: `analytics_250456953.events_20210629`
    ;;
...
view: events_20210629__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210629__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
