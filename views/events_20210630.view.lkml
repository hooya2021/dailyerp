view: events_20210630 {
  sql_table_name: `analytics_250456953.events_20210630`
    ;;
...
view: events_20210630__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210630__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
