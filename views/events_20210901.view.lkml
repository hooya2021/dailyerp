view: events_20210901 {
  sql_table_name: `analytics_258865309.events_20210901`
    ;;
...
view: events_20210901__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210901__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
