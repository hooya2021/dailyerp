view: events_20210902 {
  sql_table_name: `analytics_258865309.events_20210902`
    ;;
...
view: events_20210902__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210902__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
