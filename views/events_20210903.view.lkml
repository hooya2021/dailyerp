view: events_20210903 {
  sql_table_name: `analytics_258865309.events_20210903`
    ;;
...
view: events_20210903__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210903__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
