view: events_20210904 {
  sql_table_name: `analytics_258865309.events_20210904`
    ;;
...
view: events_20210904__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210904__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
