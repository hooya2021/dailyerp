view: events_20210905 {
  sql_table_name: `analytics_258865309.events_20210905`
    ;;
...
view: events_20210905__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_20210905__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
