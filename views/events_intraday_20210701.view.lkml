view: events_intraday_20210701 {
  sql_table_name: `analytics_250456953.events_intraday_20210701`
    ;;
...
view: events_intraday_20210701__items {
...
view: events_intraday_20210701__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_intraday_20210701__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
