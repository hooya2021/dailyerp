view: events_intraday_20210702 {
  sql_table_name: `analytics_250456953.events_intraday_20210702`
    ;;
...
view: events_intraday_20210702__items {
...
view: events_intraday_20210702__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_intraday_20210702__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
