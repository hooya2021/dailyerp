view: events_intraday_20210906 {
  sql_table_name: `analytics_258865309.events_intraday_20210906`
    ;;
...
view: events_intraday_20210906__items {
...
view: events_intraday_20210906__event_params {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
...
view: events_intraday_20210906__user_properties {
  dimension: key {
    type: string
    sql: ${TABLE}.key ;;
  }
